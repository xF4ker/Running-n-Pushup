package com.example.toosie.Activity.Main;
...
import com.example.toosie.CurrentTrack.CurrentTrackView;
...
public class MainActivity1 extends FragmentActivity
    ...
    public void clickCompletedTracksButton(final View view) {
        ...
        TimerTask changeButtonsTask = new TimerTask() {
            @Override
            public void run() {
                Intent completedTracksIntent = new Intent(MainActivity1.this, CompletedTracksActivity.class);
